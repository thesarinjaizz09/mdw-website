  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-3.5 hover:shadow-md hover:border-green-100 transition-all group flex flex-col" onClick={handleNavigation}>
      ...
      <div className="flex-1 flex flex-col gap-1.5">
        ...
        <PriceDisplay price={medicine.price} mrp={medicine.mrp} discount={medicine.discount} size="sm" />
      ...
      <Button
        ...
        className="mt-3 w-full bg-white border border-green-600 text-green-700 hover:bg-green-600 hover:text-white transition-colors h-8 text-xs font-medium rounded-lg gap-1.5"
        variant="outline"
      >
